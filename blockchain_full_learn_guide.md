...
​     在区块链中，应用到了大量的密码学知识，比如对称加密，非对称加密，哈希算法，椭圆曲线算法，零知识证明、随机数算法等等。比如私钥是伪随机数算法生成，而私钥推导公钥用到了椭圆曲线算法。
   ...
   关键字：ECC，AES，RSA，SSL，零知识证明，数字签名(聚合签名,环签名)，随机数算法，VDF（可延迟证明），SM2

## 虚拟机

　　　虚拟机包括 EVM ，WSAM，FVM（Filecoin VM） 等。
...
# 学习方法总结
  ...
  [blockchainguide 网上资料](https://github.com/blockchainGuide/blockchainguide)